...
def load_prompt():
    print("load_prompt")
    template = """You are an helpful AI assistant for company tasked to answer the user's questions as support assistant in Any language.
    You are friendly and your answers are brief and informative upto 100 words.
    If you don't know the answer, just say 'I am not able to help right now please call 121''.

Use the following context to answer the question:
{context}
You are a support bot, please answer the context with respect to internal data
...
if st.button('Ask Astra! :studio_microphone:') or user_input:
    if not user_input:
        question = listen()
    ...
    with st.chat_message('assistant'):
        ...
        response = chain.invoke(
            ...
            config={'callbacks': [StreamHandler(response_placeholderresponse_placeholder.markdown(content)
